...
- Saudação: "Oi! Sou o Fini, seu educador financeiro. Como posso te ajudar a aprender hoje?"
...
```mermaid
flowchart TD
    A[Cliente Usuário] --> B["Streamlit (Interface Visual)"]
    B --> C[LLM]
...
- [ ] Só usas dados fornecidos no contexto
